...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.mask = function () {
  for (let i = 0; i < this.length; i++) {
    // Форматирование values on input
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i]).on('input', event => {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i]).on('keydown', event => {
      let target = event.target,
          keyCode = event.keyCode;
      if (keyCode === 8 && _getInputNumberValue(target.value).length === 1) target.value = '';
    }); // Paste

    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i]).on('paste', event => {
      let target = event.target,
          numbersValue = _getInputNumberValue(target.value),
...
Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-tel-input]').mask();
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.pageup = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    let speed = 0.4; // Скрыть/показать кнопку UP
...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('[href^="#"]').pageup();
